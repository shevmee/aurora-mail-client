...
public:
    ...
    explicit EmailListManager(QVBoxLayout* mailItemsLayout,
    ...
    void applyFetchResults(const QVector<aurora::mail::app::email::EmailSummary>& emails,
                           bool append,
...
private:
    ...
    void updateCache(const QString& mailbox,

...
public:
    ...
    [[nodiscard]] AiProviderKind providerKind() const noexcept { return m_providerKind; }
...
private:
    void sendRequest(const QString& systemPrompt, const QString& userText,
                     std::function<void(const Result&)> callback);
    void handleResponse(QNetworkReply* reply, const QString& originalText,
                        std::function<void(const Result&)> callback);

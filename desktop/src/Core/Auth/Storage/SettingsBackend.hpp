...
public:
     ...
     */
    explicit SettingsBackend(const QString& organization = QStringLiteral("AuroraMail"),
     ...
     */
    [[nodiscard]] static constexpr bool isSecure() noexcept { return false; }
...
static_assert(SecureStorageConcept<SettingsBackend>, 
              "SettingsBackend must satisfy SecureStorageConcept");
